...
export default function WaterFilterHero() {
  return (
    <div className="min-h-screen pt-32 flex items-center justify-center bg-gradient-to-br from-background via-background to-muted/20">
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
          ...
          >
            Advanced water filtration technology for your shower and tap. Reduces hardness, removes sediments, and
            protects your skin and hair while filtering out harmful particles.
          </motion.p>
          <motion.div
